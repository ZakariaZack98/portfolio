...
const GradientButton = ({ label, onClick }) => {
  return (
    <button
      ...
      className="relative px-8 py-3 rounded-lg font-semibold text-white transition-all duration-300 hover:shadow-lg focus:outline-none focus:ring-4 focus:ring-blue-300 focus:ring-opacity-50 overflow-hidden cursor-pointer"
    >
      <div 
